    ...
    <Section id="features" className="bg-white py-20 lg:py-28">
      <div className="container">
        <Heading
          ...
          text="Powerful tools to optimize your e-commerce strategy, all in one place."
          tag="Features"
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {benefits.map((item) => (
            <div
              key={item.id}
              className="group relative bg-surface-50 rounded-2xl p-8 border border-surface-200 hover:border-brand-200 hover:shadow-card-hover transition-all duration-300"
            >
              <div className="w-12 h-12 rounded-xl bg-brand-50 text-brand-500 flex items-center justify-center mb-5 group-hover:bg-brand-100 transition-colors">
                {iconMap[item.title] || (
              ...
              <p className="text-surface-500 text-sm leading-relaxed">{item.text}</p>
            </div>
          ))}
        </div>
      </div>
